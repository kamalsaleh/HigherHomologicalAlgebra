  ...
  function( stable_cat )
    ...
    AddShiftOnObject( stable_cat,
      function( a )
        ...
        def := CokernelProjectionOfInflation( inf );
    ...
    AddInverseShiftOnObject( stable_cat,
      function( a )
        ...
        inf := KernelEmbeddingOfDeflation( def );
    ...
    AddUnitIsomorphismWithGivenObject( stable_cat,
      ...
      function( _a_, shift_of_ishift_a )
        ...
        inf_1 := KernelEmbeddingOfDeflation( def_1 );
        
        inf_2 := InflationIntoSomeExactInjectiveObject( Source( inf_1 ) );
        
        def_2 := CokernelProjectionOfInflation( inf_2 );
    ...
    AddCounitIsomorphismWithGivenObject( stable_cat,
      ...
      function( _a_, ishift_of_shift_a )
        ...
        def_1 := CokernelProjectionOfInflation( inf_1 );
...
#        
#        inf_2 := KernelEmbeddingOfDeflation( def_2 );
#                
