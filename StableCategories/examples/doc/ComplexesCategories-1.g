...
#! @LatexOnly \ref{Subsection_jdHNiWHD10h0jRZTnnH6}. We will construct the stable
#! category of $\Ch{\CC}$ where $\CC$ is the additive closure of the $\mathbb{Q}$-algebroid defined by the quiver
#! @BeginLatexOnly
#! \begin{center}
#! \begin{tikzcd}
