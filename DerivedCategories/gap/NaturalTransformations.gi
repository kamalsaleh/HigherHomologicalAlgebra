    ...
    func :=
      function( n )
        ...
        if n < 1 then
          ...
          Assert( 0, IsCongruentForMorphisms( PreCompose( st_r_1^0, U^0 ), st_j_1^0 ) );
          ...
          Assert( 0, IsCongruentForMorphisms(
    ...
    func :=
      function( n )
        ...
        if n > -1 then
          ...
          Assert( 0, IsCongruentForMorphisms( PreCompose( st_r_m1^0, U^0 ), st_j_m1^0 ) );
