        ...
        function ( ch_cat, L )
          ...
          if L[1] > L[2] then
            ...
            for i in [ 2 .. L[2] - L[1]  + 1 ] do
              ...
              pi := CokernelProjection( cat, diffs[i-1] );
...
BindGlobal( "_complexes_ImageObjectFunctorialWithGivenImageObjects",
  function ( cat, s, alpha, mu, nu, alpha_prime, r )
    ...
    return LiftAlongMonomorphism( cat,
              ImageEmbeddingWithGivenImageObject( cat, alpha_prime, r ),
              PreCompose( cat, ImageEmbeddingWithGivenImageObject( cat, alpha, s ), nu ) );
...
BindGlobal( "_complexes_CoimageObjectFunctorialWithGivenCoimageObjects",
  function ( cat, s, alpha, mu, nu, alpha_prime, r )
    ...
    return ColiftAlongEpimorphism( cat,
              CoimageProjectionWithGivenCoimageObject( cat, alpha, s ),
              PreCompose( cat, mu, CoimageProjectionWithGivenCoimageObject( cat, alpha_prime, r ) ) );
